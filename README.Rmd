...
If you are not an R user and have no idea what any of this means, [welcome to the community](https://education.rstudio.com/)! (And you're welcome!)

## First steps

 1. Actually, ModernDive wrote an outstanding post on the first steps. [Go here and do everything they say!](https://moderndive.netlify.com/1-getting-started.html).
